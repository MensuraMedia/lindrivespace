...
# Chrome Extension Specialist (Sonnet) — LinDriveSpace
...
- **Project**: LinDriveSpace
- **Path**: /home/user/projects/lindrivespace
- **Description**: GTK3/Python disk-space explorer for Linux Mint: mounts, partitions, folder and file sizes in a TreeSize-style tree-table
- **Date**: 2026-09-14
